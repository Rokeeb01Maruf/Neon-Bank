...
export default function Dashboard({handleSavings, handleTransfer, bal,handleLoan, transfer}: dashboardPrps
  ...
  return (
    <div className="h-screen">
        ...
        <div className="w-full flex mt-5 h-full max-sm:h-full gap-x-4 max-sm:flex-col max-sm:gap-y-2">
            <div className="flex-2/3 p-4 bg-white rounded-lg shadow-lg h-fit min-h-full max-sm:mb-2">
            ...
            <div className="flex-1/3 max-sm:w-full p-4 bg-white rounded-lg shadow-lg h-full mb-2 min-h-full">
