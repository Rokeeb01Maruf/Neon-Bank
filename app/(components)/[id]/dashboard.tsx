...
export default function Dashboard({handleSavings, handleTransfer, bal,handleLoan, transfer}: dashboardPrps
  ...
  return (
    <div className="max-h-screen h-screen">
        ...
        <div className="w-full flex mt-5 max-[500]:max-h-full max-[500]:min-h-full h-full max-sm:h-fit gap-x-4 max-sm:flex-col max-sm:gap-y-2">
            ...
            <div className="flex-1/3 max-[500]:min-h-full max-[500]:max-h-full max-sm:w-full p-4 bg-white rounded-lg shadow-lg h-full mb-2 min-h-full">
