  ...
  return (
    <div>
        ...
        <div className="w-full flex gap-x-5 mt-5 max-[496]:truncate max-[496]:gap-y-2">
            <button onClick={handleTransfer} className="max-[582]:truncate rounded-lg max-[496]:justify-between max-[496]:max-w-[250px] max-[717]:text-lg max-[666]:text-sm hover:bg-primary hover:text-white max-[918]:text- max-[582]:text-[.6rem] font-bolds text-2xl flex-1/3 flex max-[582]:font-regular items-center justify-between px-4 py-2 bg-white shadow-lg"><Send className="max-[500]:w-2 max-[500]:h-2 text-white rounded-sm p-1 w-[28px] bg-secondary h-[28]"/><p className="max-[496]:text-sm">Transfer</p></button>
            <button onClick={handleSavings} className="max-[582]:truncate rounded-lg max-[496]:justify-between max-[496]:max-w-[250px] max-[717]:text-lg max-[666]:text-sm hover:bg-primary hover:text-white font-bolds max-[918]:text-xl max-[582]:text-[.6rem] max-[582]:font-regular text-2xl flex-1/3 flex items-center justify-between px-4 py-2 bg-white shadow-lg"><PiggyBank className="max-[500]:h-2 max-[500]:w-2 text-white rounded-sm p-1 w-[28px] bg-secondary h-[28]"/><p className="max-[496]:text-sm">Add to savings</p></button>
            <button onClick={handleLoan} className=" max-[582]:truncate rounded-lg max-[496]:justify-between max-[666]:text-sm max-[496]:max-w-[250px] max-[717]:text-lg hover:bg-primary hover:text-white font-bolds max-[918]:text-xl max-[582]:text-[.6rem] max-[582]:font-regular text-2xl flex-1/3 flex items-center justify-between px-4 py-2 bg-white shadow-lg"><Banknote className="text-white max-[500]:h-2 rounded-sm p-1 w-[28px] bg-secondary h-[28] max-[500]:w-2"/><p className="max-[496]:text-sm">Apply for loan</p></button>
        </div>
        <div className="w-full flex mt-5 h-70 gap-x-4 max-sm:flex-col max-sm:gap-y-2">
