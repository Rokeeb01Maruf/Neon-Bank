...
export default function Transfer({num, name, bal, update}:{num: string, name: string, bal: number, update: ()=>void}) {
    ...
    return(
        <div>
            ...
            <div className="flex max-[810]:flex-col max-w-full max-[810]:max-w-screen mt-4 gap-5">
                <div className="flex-2/3">
                    ...
                    <div className="eachfield cursor-pointer w-full mb-4 max-w-full">
                        ...
                        <div className="flex max-[500]:flex-col max-[500]:min-h-9 max-[500]:h-fit items-center hover:bg-gray-200 h-9 w-full justify-between border-gray-600 border-2 px-2 py-1 rounded-lg">
