...
export default function Home() {
  ...
  return (
    <div className="bg-light min-h-screen">
      ...
      <main className="flex mx-25 max-[1134]:mx-20 max-[871]:mx-15 max-[809]:mx-10 max-[981]:flex-col-reverse min-[982]:flex-col">
        <div className="hero">
      ...
      max-[832]:text-sm max-[1134]:px-20 max-[871]:px-15 max-[809]:px-10">
